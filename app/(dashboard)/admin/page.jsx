...
export default function AdminDashboard() {
  ...
  if (status === "loading" || loading) {
    return (
      <div className="flex items-center justify-center min-h-screen">
        ...
        />
        <div className="ml-4 text-body">Loading dashboard data...</div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <motion.div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex items-center space-x-3 mt-4 sm:mt-0">
          ...
          <button
            ...
            className="px-4 py-2 border border-border rounded-lg text-sm font-medium text-heading bg-white hover:bg-surface"
          >
      ...
      {/* Quick Actions */}
      <motion.div className="bg-gradient-to-r from-surface to-surface/80 rounded-xl shadow-soft border border-border p-6">

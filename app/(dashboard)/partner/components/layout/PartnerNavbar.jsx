...
import PartnerProfileModal from "../profile/PartnerProfileModal";

export default function PartnerNavbar({ onMenuClick }) {
                    ...
                    >
                      ...
                      <div className="py-2">
                        <button
                          ...
                          className="w-full flex items-center px-4 py-3 text-sm text-heading hover:bg-surface transition-colors"
                        >

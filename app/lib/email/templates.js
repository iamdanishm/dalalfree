  ...
  accountApproval: (data) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>You can now:</p>
        <ul>
          ${data.role === "user" || data.role === "partner" ? "<li>List and manage properties</li>" : ""}
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; margin: 20px 0;">
          ...
          <p><strong>Approved Date:</strong> ${new Date(data.approvedDate).toLocaleDateString()}</p>
        </div>
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #f8fafc; padding: 15px; border-radius: 8px; margin: 20px 0;">
          <a href="${data.actionUrl}" style="background: #2563eb; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Take Action</a>
        </div>
